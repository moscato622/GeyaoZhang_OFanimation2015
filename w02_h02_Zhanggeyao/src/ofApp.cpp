...
void ofApp::setup(){
	ofBackground(0);
		...
		h8[i]= ofRandom(20,50);	
		h9[i]= ofRandom(20,50);	
		h10[i]= ofRandom(20,50);	
		h11[i]= ofRandom(20,50);	
		h12[i]= ofRandom(20,50);	
		h13[i]= ofRandom(20,50);
		h14[i]= ofRandom(20,50);	
		h15[i]= ofRandom(20,50);	
		h16[i]= ofRandom(20,50);	
		h17[i]= ofRandom(20,50);	
		h18[i]= ofRandom(20,50);	
		h19[i]= ofRandom(20,50);
		h20[i]= ofRandom(20,50);	
		h21[i]= ofRandom(20,50);	
		h22[i]= ofRandom(20,50);	
		h23[i]= ofRandom(20,50);	
		h24[i]= ofRandom(20,50);
		h25[i]= ofRandom(20,50);
	}
